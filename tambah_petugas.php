            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Tambah Petugas</h3>
                        <p class="animated fadeInDown">
                          Tabel Petugas <span class="fa-angle-right fa"></span> Tambah Petugas
                        </p>
                    </div>
                  </div>
                </div>
...
if(isset($_POST['simpan'])){
    ...
    $simpan = mysqli_query($db, "INSERT INTO petugas VALUES(NULL, '$username', '$password', '$nama_petugas', 'Petugas')");
        if($simpan){
            echo "<script>alert('Data berhasil ditambahkan. terimaksih');
			window.location='tabel_petugas.php?w=siswa';</script>";
        }else{
