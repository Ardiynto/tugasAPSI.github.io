                ...
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                      ...
                      <ul class="nav nav-list tree">
                          <li><a href="dashboard-v1.html">SMKN1LINGSAR</a></li>
            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Edit Kelas</h3>
                        <p class="animated fadeInDown">
                          Tabel Kelas <span class="fa-angle-right fa"></span> Edit Kelas
                        </p>
                    </div>
                  </div>
                </div>
...
if(isset($_POST['simpan'])){
    ...
    $update = mysqli_query($db, "UPDATE kelas SET nama_kelas='$nama_kelas', kompetensi_keahlian='$kompetensi_keahlian'
                                 WHERE kelas.id_kelas='$id_kelas'");
        if($update){
				echo "<script>alert('Data berhasil ditambahkan. terimaksih');
			window.location='tabel_kelas.php?w=kelas';</script>";
        }else{
...
while($row = mysqli_fetch_assoc($kelas)){?>
								 ...
								 <div class="form-group">
                                           <label></label>
                                               <input class="form-control" type="hidden" name="id_kelas"value="<?= $row['id_kelas']; ?>">
										...
										<div class="form-group">
                                            <label>Kompetensi Keahlian</label>
                                               <input class="form-control" type="text" name="kompetensi_keahlian"value="<?= $row['kompetensi_keahlian']; ?>">
                                        </div>
