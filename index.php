...
$hasil = mysqli_fetch_assoc($panggil);
    if($hasil['level'] == "Administrator"){ ?>
				 <li><a href="tabel_siswa.php">Tabel Siswa</a></li>
                  ...
                  <li><a href="history.php">History Pembayar</a></li>
				  <li role="separator" class="divider"></li>
				  <li><a href="longout.php">Logout</a></li>
				  <?php } ?>
                </ul>
              </li>
              </ul>
                   ...
                   <ul class="dropdown-menu user-dropdown">
                     ...
                     <li class="more">
                      <ul>
                        ...
                        <li><a href="longout.php"><span class="fa fa-power-off "></span></a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
      ...
      <!-- start: Content -->
            ...
            <div id="content">
			  ...
			  <center> <br><font size="4" ><marquee width="750" height="30" bgcolor="white">Slamat Datang Di aplikasi Pembayaran SPP SMKN 1 lingsar&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;&nbsp;&nbsp;&nbsp;&ensp;Jangan Lupa Pakai Masker  </marquee></font>
               </center>     
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel-heading"><h3>
								<center><div class="btn-group">
                                       <h3 class="animated fadeInLeft">SLAMAT DATANG DI APLIKASI PEBAYARAN SPP SMKN 1 LINGSAR</h3>
                                      </div></center>
					</h3>
