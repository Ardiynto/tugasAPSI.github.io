...
<head>
  ...
  <title>Bukti Pembayara SPP siswa</title>
          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              <div class="opener-left-menu is-open">
                ...
                <a href="index_siswa.php" class="navbar-brand"> 
                   ...
                   <ul class="dropdown-menu user-dropdown">
                     ...
                     <li class="more">
                      <ul>
                        ...
                        <li><a href="logout_siswa.php"><span class="fa fa-power-off "></span></a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                      ...
                      <ul class="nav nav-list tree">
                          <li><a href="cetak_siswa.php">CETAK</a></li>
                    ...
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-file-code-o"></span> Logout Di Sini   <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      <ul class="nav nav-list tree">
              ...
              <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Biodata Siswa</h3>
                        <p class="animated fadeInDown">
                          Data Siswa <span class="fa-angle-right fa"></span> Bukti pembayaran spp Siswa
                        </p>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>
							<center><h2>Hallo, <?= $result['nama']; ?></h2></center>
    <h3>Biodata Kamu</h3>
