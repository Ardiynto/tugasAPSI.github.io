            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Tambah Siswa</h3>
                        <p class="animated fadeInDown">
                          Tabel Siswa <span class="fa-angle-right fa"></span> Tambah Siswa
                        </p>
                    </div>
                  </div>
              </div>
...
if(isset($_POST['simpan'])){
    ...
    ('$nisn', '$nis', '$nama', '$kelas', '$alamat', '$no_telp')");
        if($simpan){
...
?>
                        ...
                        <form class="cmxform" id="signupForm" method="get" action="">
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nisn" name="nisn" >
                              <span class="bar"></span>
                              <label>NISN</label>
                            </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nis" name="nis" required>
                              <span class="bar"></span>
                              <label>NIS</label>
                            </div>
    ...
    <?php } ?>
                            ...
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="no_telp" name="no_telp" required>
                              <span class="bar"></span>
                          ...
                          <div class="col-md-12">
							...
							<button type="submit" name="simpan" class="btn btn-warning btn-mini">Simpan</button>
							<button type="reset" class="btn btn-danger btn-mini">Batal</button>
