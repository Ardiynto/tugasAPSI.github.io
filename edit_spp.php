            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Edit SPP</h3>
                        <p class="animated fadeInDown">
                         Tabel SPP <span class="fa-angle-right fa"></span> Edit SPP
                        </p>
                    </div>
                  </div>
                </div>
...
if(isset($_POST['simpan'])){
    ...
    $update = mysqli_query($db, "UPDATE spp SET tahun='$tahun', nominal='$nominal'
        ...
        if($update){
            ...
            echo"<script>alert;
				window.location='tabel_spp.php?w=spp';
			</script>";
        }
}
?>
...
while($row = mysqli_fetch_assoc($spp)){?>
								 ...
								 <div class="form-group">
                                           <label></label>
                                               <input class="form-control" type="hidden" name="id_spp"value="<?= $row['id_spp']; ?>">
                                            
                                        </div>
                                        <div class="form-group">
                                            <label>Tahun</label>
                                               <input class="form-control" type="text" name="tahun"value="<?= $row['tahun']; ?>">
                                            
                                        </div>
										<div class="form-group">
                                            <label>Nominal</label>
                                               <input class="form-control" type="text" name="nominal"value="<?= $row['nominal']; ?>">
                                        </div>
