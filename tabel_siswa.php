            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Tabel Siswa</h3>
                        <p class="animated fadeInDown">
                          Data Siswa <span class="fa-angle-right fa"></span> Tabel Siswa
                        </p>
                    </div>
                  </div>
              </div>
              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Data Siswa
								<div class="btn-group">
                                         <a href="tambah_siswa.php"><button class="btn btn-success">Tambah Data <i class="icon-plus icon-white"></i></button></a>
                                      </div>
					</h3>
...
while($r = mysqli_fetch_assoc($sql)){ ?>
        <tr>
            ...
            <td><?= $r['nis']; ?></td>
            <td><?= $r['nama']; ?></td>
            <td><?= $r['id_kelas'] . " | " . $r['kompetensi_keahlian']; ?></td>
            <td><?= $r['alamat']; ?></td>
            <td><?= $r['no_telp']; ?></td>
...
if(isset($_GET['hapus'])){
    ...
    if($hapus){
        ...
        window.location='tabel_siswa.php?w=petugas';
		</script>";
    }
}
?>
