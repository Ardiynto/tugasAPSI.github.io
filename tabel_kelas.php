            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Tabel Kelas</h3>
                        <p class="animated fadeInDown">
                          Data Kelas <span class="fa-angle-right fa"></span> Tabel Kelas
                        </p>
                    </div>
                  </div>
              </div>
                ...
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Data Siswa
								<div class="btn-group">
                                         <a href="tambah_kelas.php"><button class="btn btn-success">Tambah Data <i class="icon-plus icon-white"></i></button></a>
                                      </div>
					</h3>
