          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>SMKN1LINGSAR</span></li>
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Tabel Petugas</h3>
                        <p class="animated fadeInDown">
                          Data Petugas <span class="fa-angle-right fa"></span> Tabel Petugas
                        </p>
                    </div>
                  </div>
              </div>
              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Data Petugas
								<div class="btn-group">
                                         <a href="tambah_petugas.php"><button class="btn btn-success">Tambah Data <i class="icon-plus icon-white"></i></button></a>
                                      </div>
					</h3>
