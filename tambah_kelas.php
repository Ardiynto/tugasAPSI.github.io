            ...
            <div id="content">
                <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    ...
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Tambah Kelas</h3>
                        <p class="animated fadeInDown">
                          Tabel Kelas <span class="fa-angle-right fa"></span> Tambah Kelas
                        </p>
                    </div>
                  </div>
                </div>
...
if(isset($_POST['simpan'])){
    ...
    $simpan = mysqli_query($db, "INSERT INTO kelas VALUES(NULL, '$nama_kelas', '$kompetensi_keahlian')");
        if($simpan){
                          ...
                          <div class="col-md-12">
						    <form role="form">
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="kompetensi_keahlian" required>
